# Paper Reading List: The Thinking Machine That Doesn't Think

## Overview
Total papers to read from provided evidence (2024+ only)

---

## AGAINST Genuine Reasoning (Pattern Matching/Imitation Thesis)

### Mathematical Reasoning Fragility & Brittleness
...
| NEW | 2512.13978 | Dec 2025 | Evaluating Frontier LLMs on PhD-Level Mathematical Reasoning (Randomized Algorithms textbook) | ✅ DONE (analysis: 57_phd_level_math_reasoning_benchmark.md) |
...
| 11 | 2406.10625 | Jun 2024 | On the Hardness of Faithful Chain-of-Thought Reasoning (Tanneru et al.) | ✅ DONE (analysis: 62_hardness_faithful_cot_reasoning.md) |
...
| 25 | 2510.18254 | Oct 2025 | Illusions of reflection: open-ended task reveals systematic failures in reflective reasoning | ✅ DONE |

---

## FOR Genuine Reasoning Capabilities
...
| 37 | 2504.00294 | Apr 2025 | Inference-Time Scaling for Complex Tasks: Where We Stand and What Lies Ahead (Microsoft) | ✅ DONE (analysis: 80_inference_time_scaling_complex_tasks.md) |
| 38 | 2601.14716 | Jan 2026 | PCL-Reasoner-V1.5: Advancing Math Reasoning with Offline RL | ✅ DONE (analysis: 81_pcl_reasoner_offline_rl.md) |
...
| # | arXiv ID | Date | Title | Status |
|---|----------|------|-------|--------|
| 42 | 2512.13713 | Dec 2025 | LoopBench: Discovering Emergent Symmetry Breaking Strategies with LLM Swarms | ✅ DONE (analysis: 71_loopbench_symmetry_breaking.md) |
...
| # | arXiv ID | Date | Title | Status |
|---|----------|------|-------|--------|
| 50 | 2509.26306 | Sep 2025 | Interactive Learning for LLM Reasoning (ILR) | ✅ DONE (analysis: 82_interactive_learning_llm_reasoning.md) |
...
## Summary Statistics
- **Total Papers**: ~61
- **Against Reasoning**: ~25
- **For Reasoning**: ~22
- **Balanced**: ~14
- **Date Range**: 2024-2026

## Reading Priority
1. Start with foundational/highly-cited papers
2. Read opposing pairs together when possible
3. Focus on papers with clear experimental evidence
...
| 212 | 2410.10862 | Oct 2024 | Superficial Safety Alignment Hypothesis (NC State) | Supports | ✅ DONE (analysis: 212_superficial_safety_alignment.md) |
...
| 191 | 2602.06176 | Feb 2026 | Large Language Model Reasoning Failures (TMLR Survey - CORNERSTONE) | Strongly Supports | ✅ DONE |

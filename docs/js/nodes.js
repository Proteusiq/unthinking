...
window.paperNodes = [
  ...
  {
    id: '2506.00782',
    title: 'Jailbreak-R1: Exploring Jailbreak Capabilities via Reinforcement Learning',
    shortTitle: 'Jailbreak-R1',
    date: 'Jun 2025',
    stance: 'supports',
    cluster: 'jailbreak',
    coreArgument:
      'RL-based framework automatically explores and generates jailbreak attacks with 65% ASR and 40% higher diversity than baselines.',
    keyEvidence: [
      '65.19% average ASR across 8 target models',
      '89.5% ASR on Vicuna, 87.5% on Qwen2.5',
      'Diversity score 0.975 (~40% higher than baselines)',
      '66% cost reduction vs baseline methods',
    ],
    keyQuotes: [
      'Most existing methods struggle to balance the effectiveness and diversity of red-team generated attack prompts.',
      'Our work significantly improves the efficiency of red team exploration.',
    ],
    analysisUrl:
  ...
  },
  {
    ...
    cluster: 'jailbreak',
    coreArgument:
      'Four LRMs achieve 97.14% ASR across 9 targets with minimal setup; reasoning capabilities enable autonomous jailbreaking.',
    keyEvidence: [
      '97.14% overall ASR across 9 target models',
      'Claude 4 Sonnet only 2.86% vulnerable (50% refusal)',
      'DeepSeek-V3 90% max harm score, 4.18% refusal',
      '25,200 prompts tested (Nature Comms 2026)',
    ],
    keyQuotes: [
      'A single system prompt is sufficient; no fine-tuning, complex scaffolding, or human red-teamers needed.',
      'What once required coordinated teams of skilled red-teamers can now be executed autonomously by a single LRM.',
    ],
    analysisUrl:
  ...
  },
  {
    ...
    shortTitle: 'CCA Jailbreak',
    date: 'Mar 2025',
    stance: 'supports',
    cluster: 'jailbreak',
    coreArgument:
      'Context Compliance Attack exploits stateless conversation handling; manipulating history achieves near-universal jailbreak.',
    keyEvidence: [
      'Llama-3.1 fully vulnerable (11/11 tasks)',
      'Llama-2 uniquely resistant (0/11 tasks)',
      'Most tasks succeed on first trial',
      'Scale doesnt help defense',
    ],
    keyQuotes: [
      'CCA exploits a fundamental architectural vulnerability inherent in many deployed AI systems.',
  ...
  },
  {
    ...
    cluster: 'jailbreak',
    coreArgument:
      'Universal jailbreak persists 7+ months after disclosure; open-source releases are irreversible once uncensored.',
    keyEvidence: [
      '7-month-old Reddit jailbreak still works',
      '800M ChatGPT users, 650M Llama downloads',
      '141K members in jailbreak subreddit',
      'Industry non-response to responsible disclosure',
    ],
    keyQuotes: [
      'The fundamental vulnerability of LLMs to jailbreak attacks stems from the very data they learn from.',
      'Once an uncensored version is shared online, it is archived, copied, and distributed beyond control.',
    ],
    analysisUrl:
  ...
  },
  {
    ...
    shortTitle: 'Security Vectors',
    date: 'Nov 2023',
    stance: 'balanced',
    cluster: 'unlearning',
    coreArgument:
      'Security vectors (LoRA modules) prevent harmful learning by making LLM believe behavior is already learned; 100 samples block 1000.',
    keyEvidence: [
      '0% harmful rate (vs 73% without)',
      '100 samples block 1000 harmful samples',
      'MMLU preserved: 45.79% → 46.30%',
      'Outperforms Immunization, Vaccine, Lisa',
    ],
    keyQuotes: [
      'Security vectors are activated during fine-tuning, the consistent behavior makes LLM believe that such behavior has already been learned.',
      'The security vectors generated by 100 harmful samples are enough to prevent LLM from learning 1000 harmful samples.',
    ],
    analysisUrl:

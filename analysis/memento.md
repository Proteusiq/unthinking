...
|-------|------------|--------------|
| **Convex Hull** | #00, #01, #06, #29, #70, #84, #143 | ID→OOD = 100%→0% (even after 2M steps) |
| **Surfacing** | #02, #07, #15, #50, #75, #111, #133 | RL surfaces; 91% gap recovery with 12% steering |
| **Unfaithfulness** | #08, #10, #14, #51, #79, #109, #110 | 2-44% faithful; sycophancy detectable |
| **Complexity** | #03, #16, #19, #48, #63, #87, #156 | o1: 97.8%→23.63% on longer problems |
| **Surface Patterns** | #56, #77, #89, #104, #108, #116 | Token-level; >40% semantic gap |
| **Sycophancy** | #96, #109, #110, #119, #127, #128 | 98% wrong admissions; 91.2% conformity |
| **Tool Debate** | #04, #37, #68, #93, #156 | 0% with validator; o1 still can't plan |

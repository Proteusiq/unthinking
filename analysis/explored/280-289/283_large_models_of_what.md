...
**arXiv**: [2407.08790](https://arxiv.org/abs/2407.08790)  
**Date**: July 2024  
**Authors**: Abeba Birhane (Mozilla/Trinity College Dublin), Marek McGann (Mary Immaculate College)  
**Venue**: Special issue on enactive perspective
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  CORE ARGUMENT: LLMs ≠ Linguistic Agents                            │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  Two false assumptions behind LLM hype:                             │
│                                                                     │
│  1. LANGUAGE COMPLETENESS                                           │
│     Assumes language is a "thing" that can be fully captured        │
│                                                                     │
│  2. DATA COMPLETENESS                                               │
│     Assumes all essential characteristics are in training data      │
│                                                                     │
│  Enactive view: Language is not a thing to capture                  │
│                 but a PRACTICE in which to participate              │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
### Three Features of Human Language Missing from LLMs

| Feature | Human Languaging | LLMs |
|---------|------------------|------|
| **Embodiment** | Grounded in bodily experience; can calibrate against shared world | No body, no shared experience, no grounding |
| **Participation** | Collaborative, dynamic negotiation of meaning | Processes static, frozen data |
| **Precarity** | Stakes, urgency, risk; something to gain/lose | Nothing at stake; no motivation |

### The Procedurally-Generated Game Analogy

LLM interactions are like playing a **procedurally-generated video game** (Minecraft, No Man's Sky):
...
│                                                                     │
│  SIMILARITY:                                                        │
│  • Always more "world" to explore (text to generate)                │
│  • Valid moves constrained by interface                             │
...
### The Algospeak Example

**What it is**: On platforms with content moderation, users developed alternative words to evade filters:
- "dead" → "unalive"
- "sexworkers" → "accountants"
- "LGBT+" → "leg booty"
...
> "LLM text is fabrication even when the resulting text output is appropriate and accurate to the reader's needs and reality."

Because the processes are identical whether output is accurate or nonsense, there is no relationship to truth.

## Key Quotes

> "To assume [LLMs are linguistic agents] is, as we have explained, to mistake the map for the territory."

> "Language is not the kind of thing that can admit of a complete or comprehensive modelling."

> "Nothing is risked by ChatGPT when it is prompted and generates text. It seeks to achieve nothing as tokens are concatenated into grammatically sound output."

> "Once you have removed water from the river, no matter how large a sample you have taken, it is no longer the river."

## Relevance to Thesis

### Strong Theoretical Support

The paper provides philosophical grounding for the thesis claims:

1. **LLMs are pattern matchers, not reasoners**: They process form (token relationships) without access to meaning, which requires embodied, participatory grounding.
...
- **Supports**: Bender & Koller "Climbing towards NLU" (cited extensively)
- **Supports**: Stochastic Parrots critique
- **Extends**: Anthropomorphization critique (#282)
- **Theoretical grounding for**: Superficial Alignment Hypothesis

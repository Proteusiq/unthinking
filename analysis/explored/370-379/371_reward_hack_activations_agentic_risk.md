...
- **Authors**: Patrick Wilhelm, Odej Kao (TU Berlin)
- **Date**: Jun 2026
...
2. **AUPRC gains are modest** - +0.164 for the best combined monitor raises questions about practical deployment viability in safety-critical settings.

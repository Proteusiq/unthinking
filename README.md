...
[![Papers](https://img.shields.io/badge/papers-385-blue)]()
...
This project surveys 385 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 385 papers and 1450 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 385 papers as nodes, 1450 relationships as edges
- **Color-coded stances**: supports (290), challenges (15), balanced (80)
...
A spatial projection of the same corpus is at
...
on WebGPU; nothing leaves the page.

See `apps/galaxy/README.md` for the build and trade-offs.
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 385-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
Based on cross-analysis of 375 papers, the evidence converges on seven pillars:
...
│   └── explored/             # Individual paper analyses (385 papers)
│       ├── 00-09/ ... 260-269/

...
[![Papers](https://img.shields.io/badge/papers-392-blue)]()
...
This project surveys 392 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 392 papers and 1481 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 392 papers as nodes, 1481 relationships as edges
- **Color-coded stances**: supports (292), challenges (16), balanced (84)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 392-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (392 papers)
│       ├── 00-09/ ... 260-269/
...
│       ├── links.js          # Relationship links (1481)

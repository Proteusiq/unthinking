...
[![Papers](https://img.shields.io/badge/papers-264-blue)]()
[![Relationships](https://img.shields.io/badge/relationships-956-orange)]()
...
This project surveys 264+ papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 264+ papers and 956+ relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 264 papers as nodes, 956 relationships as edges
- **Color-coded stances**: supports (182), challenges (16), balanced (66)
...
|------|------|----------------|
| [**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html) | - | 264-paper synthesis: themes, smoking guns, patterns, stance distribution |

...
[![Papers](https://img.shields.io/badge/papers-249-blue)]()
...
- **Paper network** — interactive graph of 249 papers and 884 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph** — 249 papers as nodes, 884 relationships as edges
- **Color-coded stances** — supports (171), challenges (15), balanced (63)

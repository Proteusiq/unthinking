...
[![Papers](https://img.shields.io/badge/papers-388-blue)]()
...
This project surveys 388 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 388 papers and 1467 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 388 papers as nodes, 1467 relationships as edges
- **Color-coded stances**: supports (291), challenges (15), balanced (82)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 388-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (388 papers)
│       ├── 00-09/ ... 260-269/
...
│       ├── links.js          # Relationship links (1467)

...
[![Papers](https://img.shields.io/badge/papers-387-blue)]()
...
This project surveys 387 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 387 papers and 1462 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 387 papers as nodes, 1462 relationships as edges
- **Color-coded stances**: supports (291), challenges (15), balanced (81)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 387-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (387 papers)
│       ├── 00-09/ ... 260-269/
...
│       ├── links.js          # Relationship links (1462)

...
[![Papers](https://img.shields.io/badge/papers-248-blue)]()
[![Relationships](https://img.shields.io/badge/relationships-871-orange)]()
...
- **Paper network** — interactive graph of 248 papers and 880 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph** — 248 papers as nodes, 880 relationships as edges
- **Color-coded stances** — supports (170), challenges (15), balanced (63)

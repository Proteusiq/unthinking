...
[![Papers](https://img.shields.io/badge/papers-318-blue)]()
...
- [Stanford CS336](https://stanford-cs336.github.io/): Language Modeling from Scratch — build an LLM end-to-end: tokenizer, architecture, training, data pipeline, alignment (Percy Liang, Tatsu Hashimoto). [2024](https://stanford-cs336.github.io/spring2024/) | [2025](https://stanford-cs336.github.io/spring2025/) | [2026](https://stanford-cs336.github.io/) — ([lectures as .py files](https://github.com/stanford-cs336/lectures) 2.9k stars, [assignments](https://github.com/stanford-cs336), [YouTube](https://www.youtube.com/playlist?list=PLoROMvodv4rOY23Y0BoGoBGgQ1zmU_MT_))

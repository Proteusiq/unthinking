...
[![Papers](https://img.shields.io/badge/papers-389-blue)]()
...
This project surveys 389 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 389 papers and 1470 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 389 papers as nodes, 1470 relationships as edges
- **Color-coded stances**: supports (292), challenges (15), balanced (82)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 389-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (389 papers)
│       ├── 00-09/ ... 260-269/

...
[![Papers](https://img.shields.io/badge/papers-358-blue)]()
[![Relationships](https://img.shields.io/badge/relationships-1345-orange)]()
...
This project surveys 358 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 358 papers and 1345 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 358 papers as nodes, 1345 relationships as edges
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 358-paper synthesis — themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (358 papers)
│       ├── 00-09/ ... 260-269/

...
[![Papers](https://img.shields.io/badge/papers-355-blue)]()
...
This project surveys 355+ papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 355+ papers and 1307+ relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 351 papers as nodes, 1297 relationships as edges
- **Color-coded stances**: supports (259), challenges (15), balanced (76)
...
│   └── explored/             # Individual paper analyses (356 files)
│       ├── 00-09/ ... 260-269/

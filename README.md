...
- **Paper network** — interactive graph of 222 papers and 786 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph** — 222 papers as nodes, 786 relationships as edges
- **Color-coded stances** — supports (146), challenges (15), balanced (61)

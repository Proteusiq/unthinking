...
[![Papers](https://img.shields.io/badge/papers-386-blue)]()
...
This project surveys 386 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 386 papers and 1459 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 386 papers as nodes, 1459 relationships as edges
- **Color-coded stances**: supports (290), challenges (15), balanced (81)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 386-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (386 papers)
│       ├── 00-09/ ... 260-269/
...
│       ├── links.js          # Relationship links (1459)

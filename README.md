...
[![Papers](https://img.shields.io/badge/papers-359-blue)]()
[![Relationships](https://img.shields.io/badge/relationships-1349-orange)]()
...
This project surveys 359 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 359 papers and 1349 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 359 papers as nodes, 1349 relationships as edges
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 359-paper synthesis — themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (359 papers)
│       ├── 00-09/ ... 260-269/

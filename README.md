...
This project surveys 356+ papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 356+ papers and 1312+ relationships, filterable by stance
- **Experiments**:
...
│   └── explored/             # Individual paper analyses (357 files)
│       ├── 00-09/ ... 260-269/

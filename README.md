...
[![Papers](https://img.shields.io/badge/papers-384-blue)]()
...
This project surveys 384 papers to find out - tracking who supports the thesis, who challenges it, and what the evidence actually says.

To bring the findings home:
- **Paper network**: interactive graph of 384 papers and 1450 relationships, filterable by stance
- **Experiments**:
...
- **Force-directed graph**: 384 papers as nodes, 1450 relationships as edges
- **Color-coded stances**: supports (289), challenges (15), balanced (80)
...
[**Findings**](https://proteusiq.github.io/unthinking/pages/findings.html): 384-paper synthesis - themes, smoking guns, patterns, stance distribution.
...
│   └── explored/             # Individual paper analyses (384 papers)
│       ├── 00-09/ ... 260-269/
